                ...
                <div className='p-2 mt-2'>
                    <form>
                        ...
                        <div className='flex w-full my-4'>
                            <button
                                type='submit'
                                className='py-2 px-4  bg-custom-secondary hover:bg-custom-primary focus:ring-custom-secondary focus:ring-offset-custom-secondary text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg '
