const profile_styles = {
    'profile-link':
        'block p-6 max-w-sm rounded-lg border border-gray-200 shadow-md   transition ease-in-out delay-100 bg-white hover:-translate-y-1 hover:scale-110  hover:bg-gradient-to-r hover:bg-purple-500 duration-300',
};
